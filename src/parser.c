  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2170);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(1842);
      END_STATE();
    ...
    case 3:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(2196);
      if (lookahead != 0) ADVANCE(2214);
      END_STATE();
    case 4:
    ...
    case 79:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_') ADVANCE(2163);
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(2167);
      END_STATE();
    case 80:
      ADVANCE_MAP(
        '"', 81,
    ...
    case 87:
      ...
      END_STATE();
    case 88:
      if (lookahead == '1') ADVANCE(1957);
      END_STATE();
    case 89:
      if (lookahead == '3') ADVANCE(2192);
      END_STATE();
    case 90:
    ...
    case 872:
      ...
      END_STATE();
    case 873:
      if (lookahead == 'J') ADVANCE(1181);
      if (lookahead == 'S') ADVANCE(1640);
      END_STATE();
    case 874:
      if (lookahead == 'J') ADVANCE(1244);
      END_STATE();
    case 875:
      if (lookahead == 'J') ADVANCE(629);
      END_STATE();
    case 876:
      if (lookahead == 'K') ADVANCE(1874);
      END_STATE();
    case 877:
      if (lookahead == 'K') ADVANCE(1964);
      END_STATE();
    case 878:
      if (lookahead == 'K') ADVANCE(1885);
      END_STATE();
    case 879:
      if (lookahead == 'K') ADVANCE(2062);
      END_STATE();
    case 880:
    ...
    case 994:
      ...
      END_STATE();
    case 995:
      if (lookahead == 'M') ADVANCE(2120);
      END_STATE();
    case 996:
      if (lookahead == 'M') ADVANCE(2189);
      END_STATE();
    case 997:
    ...
    case 1794:
      ...
      END_STATE();
    case 1795:
      if (lookahead == 'W') ADVANCE(2095);
      END_STATE();
    case 1796:
      if (lookahead == 'W') ADVANCE(2129);
      END_STATE();
    case 1797:
      if (lookahead == 'W') ADVANCE(2024);
      END_STATE();
    case 1798:
    ...
    case 2156:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2156);
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(2167);
      if (lookahead == '-' ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_') ADVANCE(2163);
    ...
    case 2164:
      ...
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(2168);
      if (lookahead == '-' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_') ADVANCE(2164);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(2188);
      END_STATE();
    case 2165:
    ...
    case 2167:
      ...
      if (lookahead == '-' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2167);
      END_STATE();
    case 2168:
      ACCEPT_TOKEN(sym_variable);
      if (lookahead == '-' ||
    ...
    case 2196:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == ' ') ADVANCE(2196);
      if (lookahead != 0 &&
          (lookahead < '\t' || '\r' < lookahead)) ADVANCE(2214);
      END_STATE();
    case 2197:
      ACCEPT_TOKEN(sym_injection_source);
      if (lookahead == '*') ADVANCE(2194);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 2, 0, 1),
  [28] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 2, 0, 1),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_injection, 3, 0, 0),
  [32] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_injection, 3, 0, 0),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 1),
  [36] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 4, 0, 1),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 1),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 3, 0, 1),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_injection, 4, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_injection, 4, 0, 0),
  ...
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  ...
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [123] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [126] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [132] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [135] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arithmetic, 1, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arithmetic, 1, 0, 0),
  ...
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2, 0, 0),
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_command_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_injection_repeat1, 2, 0, 0),
  [185] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_injection_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
